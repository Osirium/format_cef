...
valid_extensions = {
    ...
    "destinationTranslatedAddress": Extension(
        "destinationTranslatedAddress", ipv4_addr
    ),
    "destinationTranslatedPort": Extension(
        "destinationTranslatedPort", int_sanitiser(min=0, max=65535)
    ),
    ...
    "oldFileModificationTime": Extension(
        "oldFileModificationTime", datetime_sanitiser()
    ),
    ...
    "sourceTranslatedPort": Extension(
        "sourceTranslatedPort", int_sanitiser(min=0, max=65535)
    ),
